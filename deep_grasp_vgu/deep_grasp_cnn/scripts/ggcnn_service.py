...
class GGCNNService:
    ...
    def grasp_visualization(self, grasp_message):
        ...
        pose_msg.pose.position.x = 0.1 #pose.position.x
        pose_msg.pose.position.y = 0.1 #pose.position.y
        pose_msg.pose.position.z = 0.1 #pose.position.z

        pose_msg.pose.orientation.x = 0.0 #pose.orientation.x
        pose_msg.pose.orientation.y = 0.0 #pose.orientation.y
        pose_msg.pose.orientation.z = 0.0 #pose.orientation.z
        pose_msg.pose.orientation.w = 1.0 #pose.orientation.w
